...
export const CompanionForm = ({
    ...
    return(
        <div className="h-full p-4 space-y-2 maz-w-3xl mx-auto">
           <Form {...form}>
                ...
                <div>
                    ...
                    <p>
                        General information about your chatterbot
                    </p>
                </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is how your AI Chatterbot will be named.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Short description for your AI Chatterbot
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Describe in detail your chatterbot&apos;s backstory and relevant details.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Write couple of examples of a human chatting with your AI chatterbot, write expected answers.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="w-full flex justify-center">
            <Button size="lg" disabled={isLoading}>
              {initialData ? "Edit your companion" : "Create your chatterbot"}
